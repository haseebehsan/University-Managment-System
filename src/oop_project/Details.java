...
public class Details extends javax.swing.JFrame {
    ...
    public Details(int ID, String file) {
        this.ID = ID;
        try {
            student = new RandomAccessFile(file, "rw");
            student.seek(0);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Name: "+this.Name);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Details");

        jLabel3.setText("ID: "+this.ID);

        jLabel4.setText("CNIC: "+this.CNIC);

        jLabel5.setText("Descipline: "+this.Descipline);
